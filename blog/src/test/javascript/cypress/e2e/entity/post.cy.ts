...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'genuine', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-07-25T01:03:38.347Z' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('towards likewise');
      cy.get(`[data-cy="title"]`).should('have.value', 'towards likewise');
      ...
      cy.get(`[data-cy="date"]`).type('2024-07-25T02:15');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-07-25T02:15');
